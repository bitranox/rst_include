...
long_description = "commandline tool to resolve RST File includes"
...
setup_kwargs["package_data"] = {"rst_include": ["py.typed", "*.pyi", "__init__.pyi", "*.rst", './.docs/parts/*.rst', '.docs/parts/*.rst']}
...
setup_kwargs["entry_points"] = {
    "console_scripts": ["rst_include = rst_include.rst_include_cli:cli_main"]
}
