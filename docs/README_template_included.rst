...
.. |Build Status| image:: https://travis-ci.org/bitranox/{repository}.svg?branch=master
   :target: https://travis-ci.org/bitranox/{repository}
.. for the pypi status link note the dashes, not the underscore !
.. |Pypi Status| image:: https://badge.fury.io/py/{repository_dashed}.svg
   :target: https://badge.fury.io/py/{repository}
.. |Codecov Status| image:: https://codecov.io/gh/bitranox/{repository}/branch/master/graph/badge.svg
   :target: https://codecov.io/gh/bitranox/{repository}
.. |Better Code| image:: https://bettercodehub.com/edge/badge/bitranox/{repository}?branch=master
...
- `please Contribute <https://github.com/bitranox/{repository}/blob/master/CONTRIBUTING.md>`_
