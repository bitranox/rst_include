...
def get_include_filename(block):
    ...
    >>> block = lib_test_functions.get_test_block_no_include_filename()
    >>> get_include_filename(block)  # doctest: +ELLIPSIS +NORMALIZE_WHITESPACE
    Traceback (most recent call last):
    ...
    ...
    >>> block = lib_test_functions.get_test_block_include_filename_not_existing()
    >>> get_include_filename(block)  # doctest: +ELLIPSIS +NORMALIZE_WHITESPACE
    Traceback (most recent call last):
    ...
...
def get_include_file_code(block):
    ...
    >>> # test code not set
    >>> block = lib_test_functions.get_test_block_code_not_set()
    >>> get_include_file_code(block)
    ''
    >>> assert block.include_file_code == ''

    >>> # test code invalid
    >>> block = lib_test_functions.get_test_block_code_invalid()
...
def get_include_file_encoding(block):
    ...
    >>> block = lib_test_functions.get_test_block_encoding_not_set()
    >>> get_include_file_encoding(block)
    'utf-8-sig'
    >>> assert block.include_file_encoding == 'utf-8-sig'

    >>> # test encoding invalid
    >>> block = lib_test_functions.get_test_block_encoding_invalid()
...
def get_include_file_start_line(block):
    ...
    >>> block = lib_test_functions.get_test_block_start_line_not_set()
    >>> get_include_file_start_line(block)

    >>> assert block.include_file_start_line is None

    >>> # test start-line invalid
    >>> block = lib_test_functions.get_test_block_start_line_invalid()
    ...
    >>> block = lib_test_functions.get_test_block_start_line_not_integer()
    >>> get_include_file_start_line(block)      # doctest: +ELLIPSIS +NORMALIZE_WHITESPACE
    Traceback (most recent call last):
    ...
...
def get_include_file_end_line(block):
    ...
    >>> block = lib_test_functions.get_test_block_end_line_not_set()
    >>> get_include_file_end_line(block)

    >>> assert block.include_file_end_line is None

    >>> # test end-line invalid
    >>> block = lib_test_functions.get_test_block_end_line_invalid()
    ...
    >>> block = lib_test_functions.get_test_block_end_line_not_integer()
    >>> get_include_file_end_line(block)   # doctest: +ELLIPSIS +NORMALIZE_WHITESPACE
    Traceback (most recent call last):
    ...
...
def get_include_file_start_after(block):
    ...
    >>> block = lib_test_functions.get_test_block_start_after_not_set()
    >>> get_include_file_start_after(block)
    ''

    >>> # test start-after invalid
    >>> block = lib_test_functions.get_test_block_start_after_invalid()
...
def get_include_file_end_before(block):
    ...
    >>> block = lib_test_functions.get_test_block_end_before_not_set()
    >>> get_include_file_end_before(block)
    ''

    >>> # test end-before invalid
    >>> block = lib_test_functions.get_test_block_end_before_invalid()
