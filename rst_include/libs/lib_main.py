...
def rst_str_replace(source, target, old, new, count=-1, source_encoding='utf-8-sig', target_encoding='utf-8'):
    # type: (str, str, str, str, int, str, str) -> None
...
def rst_inc_from_config(config_file_path):
    # type: (str) -> None
